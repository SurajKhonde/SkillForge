...
export default function Header({ onAddprojectClick,onAddHrManger,onAddExam }) {
  const [showOptions, setShowOptions] = useState(false);
  const { toggleTheme } = useTheme();
  const navigate = useNavigate();
  const options = [
    { title: "Add Project", onClick: onAddprojectClick },
    { title: "Hire HR", onClick: onAddHrManger },
    {title:"Add exam",onClick:onAddExam}
  ];
